import { ChartLine, Mail, Pencil, Search, Star, Trash, Trash2, User, UserCog, UserCog2, Wand } from 'lucide-react'
                    ...
                    <tbody class="whitespace-nowrap divide-y divide-gray-200">

                        {
                            visitHistory.length === 0 ?
                                ...
                                : visitHistory.map((user, index) => {
                                    const { name, phone, image, email, checkInTime, checkOutTime, employeeid, status } = user
                                    return (
                                        <tr key={index}>

                                            <td class="px-4 py-3 text-sm text-slate-900 font-medium">
                                                <div class="flex items-center cursor-pointer w-max">
                                                    <img src={image} alt="team-1" class="w-9 h-9 rounded-full shrink-0" />
